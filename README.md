...
Metric deltas across PRs (each row stacks all features from prior rows).

<!-- BENCHMARK_TABLE_START -->
| Configuration | query_graph p50 | shortest_path p50 | Call Res % | Trace % | NDCG@10 | Memory (MB) | Nodes | Edges |
|---|---|---|---|---|---|---|---|---|
| Baseline (PR 1.1) | 0.1 | 0.0 | — | — | — | 0.2 | 231 | 0 |
<!-- BENCHMARK_TABLE_END -->

_Generated by `python scripts/update-readme-table.py` from `benchmarks/*.json`._
